...
Scrivi il programma *ics* che disegna a terminale una X composta di asterischi. Il programma chiede all'utente di introdurre (come argomento da linea di comando o interattivamente) un numero intero (*N*). 
